...
const (
	AnnotationService_GetAllAnnotations_FullMethodName = "/activity.v1.AnnotationService/GetAllAnnotations"
...
func (c *annotationServiceClient) GetAllAnnotations(ctx context.Context, in *GetAllAnnotationsRequest, opts ...grpc.CallOption) (*GetAllAnnotationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllAnnotationsResponse)
	err := c.cc.Invoke(ctx, AnnotationService_GetAllAnnotations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnnotationServiceServer) GetAllAnnotations(context.Context, *GetAllAnnotationsRequest) (*GetAllAnnotationsResponse, error) {
...
func _AnnotationService_GetAllAnnotations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllAnnotationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnnotationServiceServer).GetAllAnnotations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AnnotationService_GetAllAnnotations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnnotationServiceServer).GetAllAnnotations(ctx, req.(*GetAllAnnotationsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AnnotationService_GetAllAnnotations_Handler,
		},
		{
